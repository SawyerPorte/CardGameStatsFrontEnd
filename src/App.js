...
export default function App() {
    ...
    return (
        <div className="p-6 bg-gray-800 min-h-screen w-full">
            <h1 className="text-4xl font-bold mb-8 text-center w-full text-white">
                Global Stats Dashboard
            </h1>

            <div className='grid md:grid-cols-5 auto-rows-[150px] gap-4 my-10'>
                {statCards.map((stat) => (
                    <div
                        key={stat.title}
                        className="bg-gray-500 border-2 rounded-xl p-2 text-white"
                    >
